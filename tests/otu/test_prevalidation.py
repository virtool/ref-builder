...
class TestAssignRecordsToSegments:
    """Test whether a list of records accurately maps to the segment list
    of a multipartite OTU's plan."""

    def test_ok(self, scratch_repo, taxid):
    ...
    def test_fail(self, scratch_repo, taxid):
        """Test that a randomly generated list of records raises an appropriate ValueError."""
        otu = scratch_repo.get_otu_by_taxid(taxid)
